...
export default function Sidebar({ collapsed }: { collapsed: boolean }) {
  ...
  return (
    <aside
      className={`bg-white h-[calc(100vh-0rem)] my-10 py-10 transition-all duration-300 z-50 overflow-y-auto overflow-x-hidden ${collapsed ? "w-16" : "w-62"} fixed left-0 top-0`}
    >
